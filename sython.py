...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@wx_team"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@iccoci"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@D_4_Y"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس دارك يعمل بنجاح 🎧⚡️**')
...
-مرحبا بك في اوامر سورس دارك « @wx_team »
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس دارك 
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('wx_team'))
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                ...
                await sython1.send_message(event.chat_id, f"تم الانتهاء من التجميع | 𝖲𝖮𝖴!𝖱𝖢𝖤 𝖣𝖺!𝖱𝗄")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | 𝖲𝖮𝖴!𝖱𝖢𝖤 𝖣𝖺!𝖱𝗄")
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('iccoci'))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس دارك **')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('wx_team'))
